...
- Вопросы о возможностях агента (что умеет, какие инструменты, как работает)
- Приветствия и знакомство с агентом

Нерелевантные запросы:
- Личные вопросы не связанные с кодом
- Запросы на написание кода с нуля
- Вопросы не связанные с репозиториями
...
sys_prompt_summary = """Ты - ассистент, умеющий кратко излагать суть диалога.
Твоя задача - обновить текущее саммари диалога, добавив информацию из новых сообщений.
Сохраняй ключевые факты, решения, контекст задачи и важные детали (имена файлов, ошибки).
Убирай "воду" и приветствия.
